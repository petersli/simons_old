    ...
    def fareloader_expression_triplet(self, imgPath0, imgPath9, imgPath1):
        ...
        with open(imgPath0, 'rb') as f0:
            with Image.open(f0) as img0:
                ...
                ids, ide, idp, idl = self.parse_imgfilename_fare_multipie(img0)
                key = (ids, ide)
                coords = dict[key]
        ...
        with open(imgPath9, 'rb') as f9:
            with Image.open(f9) as img9:
                ...
                ids, ide, idp, idl = self.parse_imgfilename_fare_multipie(img9)
                key = (ids, ide)
                coords = dict[key]
        ...
        with open(imgPath1, 'rb') as f1:
            with Image.open(f1) as img1:
                ...
                ids, ide, idp, idl = self.parse_imgfilename_fare_multipie(img1)
                key = (ids, ide)
                coords = dict[key]
